...
public interface SendSMSWorldSoap {
    ...
    @RequestWrapper(localName = "sendSMS", targetNamespace = "http://www.webserviceX.NET", className = "com.subrata.webservice.soap.stub.SendSMS")
    @ResponseWrapper(localName = "sendSMSResponse", targetNamespace = "http://www.webserviceX.NET", className = "com.subrata.webservice.soap.stub.SendSMSResponse")
