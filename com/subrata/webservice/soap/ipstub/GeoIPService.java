    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.subrata.webservice.soap.ipstub.GeoIPService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.subrata.webservice.soap.ipstub.GeoIPService.class.getResource(".");
